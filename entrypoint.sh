...
SLAPD_FORCE_RECONFIGURE="$INPUT_FORCE_RECONFIGURE"
SLAPD_DOMAIN="$INPUT_DOMAIN"
SLAPD_PASSWORD="$INPUT_ADMIN_PASSWORD"
SLAPD_CONFIG_PASSWORD="$INPUT_CONFIG_PASSWORD"
SLAPD_ADDITIONAL_SCHEMAS="$INPUT_ADDITIONAL_SCHEMAS"
SLAPD_ADDITIONAL_MODULES="$INPUT_ADDITIONAL_MODULES"
